package com.learningJava.learnjavaframework.example.A0;
...
class YourBusinessClass {
  ...
  // as you put auto wired on a field
  // spring would automatically do field injection.
  @Autowired
  ...
  //@Autowired(not mandatory in constructor)
